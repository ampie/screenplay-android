...
import cucumber.runtime.android.ScenarioCounter;
 ...
 */
public class CucumberScreenplayExecutor {
     ...
     *
     * @param arguments       the {@link Arguments} which configure this execution
     * @param instrumentation the {@link Instrumentation} to report to
     * @param inputResourceRoot
     */
    public CucumberScreenplayExecutor(final Arguments arguments, final Instrumentation instrumentation,  WireMockResourceRoot inputResourceRoot) {
        ...
        ResourceLoader resourceLoader = new WireMockResourceLoader(inputResourceRoot, instrumentation.getContext());
