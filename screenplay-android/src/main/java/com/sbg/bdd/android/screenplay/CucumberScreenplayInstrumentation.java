 ...
 */
public class CucumberScreenplayInstrumentation {

    /**
     * The value to be used for the {@link Instrumentation#REPORT_KEY_IDENTIFIER}.
     */
    public static final String REPORT_VALUE_ID = CucumberScreenplayInstrumentation.class.getSimpleName();
     ...
     */
    public CucumberScreenplayInstrumentation(final Instrumentation instrumentation, final WireMockResourceRoot inputResourceRoot) {
        this.instrumentation = instrumentation;
        this.inputResourceRoot = inputResourceRoot;
    }
    ...
    public void create(final Bundle bundle) {
        ...
        cucumberExecutor = new CucumberScreenplayExecutor(arguments, instrumentation,inputResourceRoot);
